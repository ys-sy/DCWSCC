...
class SwinTransformer_CDPNET4(nn.Module):
    def __init__(self,
                 img_size=384,
                 patch_size=4,
                 in_chans=3,
    ...
    def forward_features(self, x):
        ...
        # 👉 保留空间特征
        x = self.regression(x1, x2, x3, x4)   # [B,1024,48,48]
    ...
    def forward(self, x):
        ...
        feat = self.forward_features(x)   # [B,1024,48,48]

        density_map = self.density_head(feat)   # [B,1,48,48]

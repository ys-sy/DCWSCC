...
from Networks.CCST import SwinTransformerCC
from Networks.swin_transformer import SwinTransformer
from efficientnet_pytorch import EfficientNet

from Networks.swin_transformer2 import SwinTransformer2
from Networks.swin_transformer_CDPNet1 import SwinTransformer_CDPNET1
from Networks.swin_transformer_CDPNet2 import SwinTransformer_CDPNET2
from Networks.swin_transformer_CDPNet3 import SwinTransformer_CDPNET3
from Networks.swin_transformer_CDPNet4 import SwinTransformer_CDPNET4
from Networks.swin_transformer_llm import SwinTransformer_LLM
from Networks.swin_transformer_mdgcn import SwinTransformer_MDGCN
from Networks.swin_transformer_multi import SwinTransformer_MULTI
from Networks.vision_mamba import VisionMamba

from Networks.swin_transformer1 import SwinTransformer1

from Networks.swin_transformer_dynamic_kernel import SwinTransformer_DK
...
def base_patch16_384_mamba(pretrained=False, mode = 0, **kwargs):
    ...
    model = VisionMamba(
        patch_size=16, embed_dim=192, depth=24, rms_norm=True, residual_in_fp32=True, fused_add_norm=False, final_pool_type='mean', if_abs_pos_embed=True, if_rope=False, if_rope_residual=False, bimamba_type="v2", if_cls_token=True, if_devide_out=True, use_middle_cls_token=True,mode=mode, **kwargs)
...
@register_model
def base_patch16_384_swin1(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer1(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin2(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer2(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
#     model = SwinTransformerCC(img_size=384, patch_size=4, in_chans=3, num_classes=1000,
...
#         checkpoint = torch.load('Networks/swin_large_patch4_window12_384_22k.pth', map_location='cpu')
#         model.load_state_dict(checkpoint["model"], strict=False)
#         print("load transformer pretrained")
#
#
...
@register_model
def base_patch16_384_swin_llm(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_LLM(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_dk(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_DK(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_multi(pretrained=False, mode = 0, **kwargs):
    # 对swin_transformer主干进行尺度的融合
    model = SwinTransformer_MULTI(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_mdgcn(pretrained=True, mode = 0, **kwargs):
    model = SwinTransformer_MDGCN(img_size=384, patch_size=4, in_chans=3, num_classes=21841,
                 embed_dim=192, depths=[2, 2, 18, 2], num_heads=[ 6, 12, 24, 48 ],
                 window_size=12, mlp_ratio=4., qkv_bias=True, qk_scale=None,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,
                 norm_layer=nn.LayerNorm, ape=False, patch_norm=True,
                 use_checkpoint=True, mode=mode,**kwargs)
    # model.default_cfg = _cfg()
    if pretrained:
        checkpoint = torch.load('Networks/swin_large_patch4_window12_384_22k.pth', map_location='cpu')
        model.load_state_dict(checkpoint["model"], strict=False)
...
@register_model
def base_patch16_384_swin_cdpnet(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_CDPNET(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_cdpnet1(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_CDPNET1(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_cdpnet2(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_CDPNET2(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_cdpnet3(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_CDPNET3(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,
...
@register_model
def base_patch16_384_swin_cdpnet4(pretrained=False, mode = 0, **kwargs):
   # base SwinTransformer
    model = SwinTransformer_CDPNET4(img_size=384,
                            patch_size=4,
                            in_chans=3,
                            num_classes=1,
                            embed_dim=128,

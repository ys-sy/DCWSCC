...
from Networks.models import base_patch16_384_token, base_patch16_384_gap, base_patch16_384_attention, \
    ...
    base_patch16_384_swin_mdgcn, base_patch16_384_swin_cdpnet, base_patch16_384_swin_cdpnet1, \
    base_patch16_384_swin_cdpnet2, base_patch16_384_swin_cdpnet3, base_patch16_384_swin_cdpnet4, base_patch16_384_swin2
...
def main(args):
    ...
    if args['model_type'] == 'token':
        ...
        model = base_patch16_384_swin2(pretrained=True,mode = args['mode'])
    ...
    elif args['model_type'] == 'swinmdgcn':
        model = base_patch16_384_swin_mdgcn(pretrained=True,mode = args['mode'])

    elif args['model_type'] == 'swincdpnet':
        model = base_patch16_384_swin_cdpnet(pretrained=True,mode = args['mode'])

    elif args['model_type'] == 'swincdpnet1':
        model = base_patch16_384_swin_cdpnet1(pretrained=True,mode = args['mode'])

    elif args['model_type'] == 'swincdpnet2':
        model = base_patch16_384_swin_cdpnet2(pretrained=True,mode = args['mode'])

    elif args['model_type'] == 'swincdpnet3':
        model = base_patch16_384_swin_cdpnet3(pretrained=True,mode = args['mode'])

    elif args['model_type'] == 'swincdpnet4':
        model = base_patch16_384_swin_cdpnet4(pretrained=True,mode = args['mode'])
